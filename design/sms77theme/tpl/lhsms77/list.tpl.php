<h1><?= erTranslationClassLhTranslation::getInstance()
        ->getTranslation('module/fbmessenger', 'Sms77 phones') ?></h1>
                ...
                <td nowrap>
                    <div class='btn-group' role='group' aria-label='...'
                        ...
                        <a class='btn btn-default btn-xs'
                           href='<?= erLhcoreClassDesign::baseurl('sms77/edit') ?>/<?= $item->id ?>'>
                        ...
                        <a class='btn btn-danger btn-xs csfr-required'
                           ...
                           href='<?= erLhcoreClassDesign::baseurl('sms77/delete') ?>/<?= $item->id ?>'>
                            <i class='material-icons mr-0'>&#xE872;</i></a>
                    </div>
                </td>
            </tr>
...
<a href='<?= erLhcoreClassDesign::baseurl('sms77/new') ?>' class='btn btn-default'>
