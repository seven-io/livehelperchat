...
class erLhcoreClassModelSms77Phone {
        ...
        switch ($var) {
            case 'callback_url':
                $this->callback_url = erLhcoreClassXMP::getBaseHost()
                    . $_SERVER['HTTP_HOST']
                    . erLhcoreClassDesign::baseurldirect('sms77/callbacks');
    ...
    public function beforeRemove() {
        ...
        $q->deleteFrom('lhc_sms77_chat')->where(
